...
const F = (
    ...
    B = (
        ...
        if (
            ((D.attributes.class = c(D.attributes.class, r.table)), d || h || w)
        ) {
            const t = F(
                e,
                i,
...
class at {
    ...
    multiSearch(t, e = "search") {
        ...
        if (
            (this.emit("datatable.multisearch:before", s, this._searchData),
            e.length &&
                (s = s.concat(
        ...
        this.data.data.forEach((t, e) => {
            const a = t.cells.map((t, e) => {
                ...
                if (i.length) {
                    ...
                    (s.ignorePunctuation ?? this.options.ignorePunctuation) &&
                        (i = i.replace(/[.,/#!$%^&*;:{}=-_`~()]/g, ""));
                }
                const a =
                    s.searchItemSeparator || this.options.searchItemSeparator;
