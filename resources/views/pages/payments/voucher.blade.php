                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col">
                                                                <h6 class="mb-1"><span class="text-truncate w-100">Artisan
                                                                        UI</span></h6>
                                                                <p class="f-12 mb-0"><a href="#!"
                                                                        class="text-muted"><span
                                                                            class="text-truncate w-100">0316-8336096</span></a>
                                                    ...
                                                    <td>7/11/2022</td>
                                                    <td>3000 Pkr</td>
                                                    <td><span class="badge bg-light-danger">Cancelled</span>
                                                    <td class="text-end">
                                                        <ul class="list-inline mb-0">
                                                            {{-- <li class="list-inline-item"
                                    ><a href="{{ route('payment.show') }}" class="avtar avtar-xs btn-link-secondary"><i class="ti ti-eye f-20"></i></a
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col">
                                                                <h6 class="mb-1"><span
                                                                        class="text-truncate w-100">Ashton
                                                                        Cox</span></h6>
                                                                <p class="f-12 mb-0"><a href="#!"
                                                                        class="text-muted"><span
                                                                            class="text-truncate w-100">0316-8336096</span></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col">
                                                                <h6 class="mb-1"><span
                                                                        class="text-truncate w-100">Williamson
                                                                    </span></h6>
                                                                <p class="f-12 mb-0"><a href="#!"
                                                                        class="text-muted"><span
                                                                            class="text-truncate w-100">0316-8336096</span></a>
                                  ...
                                  ></li> --}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row align-items-center">
                                                            <div class="col-auto pe-0">
                                                                <img src="../assets/images/user/avatar-6.jpg"
                                                                    alt="user-image"
                                                                    class="wid-40 hei-40 rounded-circle" />
                                                            </div>
                                                            <div class="col">
                                                                <h6 class="mb-1"><span class="text-truncate w-100">Airi
                                                                        Satuo</span></h6>
                                                                <p class="f-12 mb-0"><a href="#!"
                                                                        class="text-muted"><span
                                                                            class="text-truncate w-100">0316-8336096</span></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col">
                                                                <h6 class="mb-1"><span
                                                                        class="text-truncate w-100">Bredly
                                                                        Greer</span></h6>
                                                                <p class="f-12 mb-0"><a href="#!"
                                                                        class="text-muted"><span
                                                                            class="text-truncate w-100">0316-8336096</span></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col">
                                                                <h6 class="mb-1"><span
                                                                        class="text-truncate w-100">Ashton Cox
                                                                    </span></h6>
                                                                <p class="f-12 mb-0"><a href="#!"
                                                                        class="text-muted"><span
                                                                            class="text-truncate w-100">0316-8336096</span></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col">
                                                                <h6 class="mb-1"><span class="text-truncate w-100">Anaya
                                                                        Khan</span></h6>
                                                                <p class="f-12 mb-0"><a href="#!"
                                                                        class="text-muted"><span
                                                                            class="text-truncate w-100">0316-8336096</span></a>
                            ...
                            <div class="col-12">
                                ...
                                <div class="text-end btn-page mb-0 mt-4 me-0">
                                    <a href="#" class="btn btn-outline-secondary" type="button"
                                        data-bs-dismiss="modal" data-bs-toggle="tooltip">Cancel</a>
                                    <a href="#" class="btn btn-primary" data-bs-dismiss="modal">Submit</a>
                                </div>
                            </div>
                        </div>
                    </div>
