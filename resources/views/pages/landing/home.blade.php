          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="../assets/images/user/saqib.jpg" alt="user-image" class="user-avtar wid-100 rounded-circle mb-3" />
                <h2 class="text-white mb-0">Govt High Secondary School No 1 Abbottabad</h2>
              </div>
          </div>
        </div>
      </div>
